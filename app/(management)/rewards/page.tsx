...
<button className="btn btn-info" onClick={()=>document.getElementById('my_modal_3').showModal()}>Add Rewards</button>
<dialog id="my_modal_3" className="modal">
        <div className="modal-box">
          ...
          <div className="form-control bg-white">
            ...
            <input type="text" placeholder="Enter Cost" className="input input-bordered" />
            <label className="label">
              <span className="label-text">Name</span>
            </label>
