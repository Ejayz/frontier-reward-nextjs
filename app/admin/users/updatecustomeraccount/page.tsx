            ...
            <Form>
              <div className="customer grid grid-cols-3 gap-x-2">
                <LabeledInput
                  ...
                  classes="text-base"
                  label="First Name"
                  datatip="Input for the first name of the customer."
                />
                <LabeledInput
                  ...
                  classes="text-base"
                  label="Middle Name"
                  datatip="Input for the middle name of the customer."
                />
                <LabeledInput
                  ...
                  classes="text-base"
                  label="Last Name"
                  datatip="Input for the last name of the customer."
                />
                <LabeledInput
                  field_name="suffix"
                  type="text"
                  ...
                  classes="text-base"
                  label="Suffix"
                  datatip="Input for the suffix of the customer."
                />
                <LabeledInput
                  field_name="email"
                  type="email"
                  ...
                  classes="text-base"
                  label="Email"
                  datatip="Input for the email of the customer."
                />
                <LabeledInputPhone
                  ...
                  classes="text-base"
                  label="Phone Number"
                  datatip="Input for the phone number of the customer."
                ...
                <LabeledInput
                  ...
                  classes="text-base"
                  label="Points"
                  datatip="Input for the points of the customer."
                />
                <LabeledSelectInput
                  field_name="package"
                  type="text"
                  ...
                  classes="text-base"
                  label="Package"
                  datatip="Select for the package of the customer."
                ...
                <LabeledSelectInput
                  ...
                  classes="text-base"
                  label="Country"
                  datatip="Select for the country of the customer."
                ...
                <LabeledInput
                  ...
                  classes="text-base"
                  label="Address Line"
                  datatip="Input for the address line of the customer."
                />
                <LabeledInput
                  ...
                  datatip="Input for the address line 2 of the customer."
                />
                <LabeledInput
                  field_name="city"
                  type="text"
                  ...
                  classes="text-base"
                  label="City"
                  datatip="Input for the city of the customer."
                />
                <LabeledInput
                  ...
                  datatip="Input for the state/province/region of the customer."
                />
                <LabeledInput
                  field_name="zip_code"
                  type="text"
                  ...
                  datatip="Input for the zip/postal code of the customer."
                />
              </div>
            </Form>
          )}
